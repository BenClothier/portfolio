            ...
            <div className="card">
                <div class="row">
                    ...
                    <div class="column">
                        ...
                        <div className="divider" />
                        <div className="skillbox"><p>Visual Studio</p> <img id="twoStars" src={twoStars} alt="twoStars"/></div>
                        <div className="divider" />
                        ...
                        <div className="divider" />
                        <div className="skillbox"><p>OpenGL</p> <img id="oneStar" src={oneStar} alt="oneStar"/></div>
                        <div className="divider" />
